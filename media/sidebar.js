...
(() => {
  ...
  function P(n2, l3, u4, t3, i3, r4, o3, e3, f4, c3, s3) {
    ...
    for (f4 = A(u4, l3, m3, f4, b3), a3 = 0; a3 < b3; a3++) null != (y3 = u4.__k[a3]) && (h4 = -1 != y3.__i && m3[y3.__i] || p, y3.__i = a3, g4 = z(n2, y3, h4, i3, r4, o3, e3, f4, c3, s3), d3 = y3.__e, y3.ref && h4.ref != y3.ref && (h4.ref && D(h4.ref, null, y3), s3.push(y3.ref, y3.__c || d3, y3)), null == w4 && null != d3 && (w4 = d3), (_3 = !!(4 & y3.__u)) || h4.__k === y3.__k ? f4 = H(y3, f4, n2, _3) : "function" == typeof y3.type && void 0 !== g4 ? f4 = g4 : d3 && (f4 = d3.nextSibling), y3.__u &= -7);
    return u4.__e = w4, f4;
  }
  function A(n2, l3, u4, t3, i3) {
    var r4, o3, e3, f4, c3, s3 = u4.length, a3 = s3, h4 = 0;
    for (n2.__k = new Array(i3), r4 = 0; r4 < i3; r4++) null != (o3 = l3[r4]) && "boolean" != typeof o3 && "function" != typeof o3 ? ("string" == typeof o3 || "number" == typeof o3 || "bigint" == typeof o3 || o3.constructor == String ? o3 = n2.__k[r4] = m(null, o3, null, null, null) : d(o3) ? o3 = n2.__k[r4] = m(k, { children: o3 }, null, null, null) : void 0 === o3.constructor && o3.__b > 0 ? o3 = n2.__k[r4] = m(o3.type, o3.props, o3.key, o3.ref ? o3.ref : null, o3.__v) : n2.__k[r4] = o3, f4 = r4 + h4, o3.__ = n2, o3.__b = n2.__b + 1, e3 = null, -1 != (c3 = o3.__i = T(o3, u4, f4, a3)) && (a3--, (e3 = u4[c3]) && (e3.__u |= 2)), null == e3 || null == e3.__v ? (-1 == c3 && (i3 > s3 ? h4-- : i3 < s3 && h4++), "function" != typeof o3.type && (o3.__u |= 4)) : c3 != f4 && (c3 == f4 - 1 ? h4-- : c3 == f4 + 1 ? h4++ : (c3 > f4 ? h4-- : h4++, o3.__u |= 4))) : n2.__k[r4] = null;
  ...
  function z(n2, u4, t3, i3, r4, o3, e3, f4, c3, s3) {
    var a3, h4, p3, y3, _3, m3, b3, S2, C4, M3, $3, I3, A4, H3, L3, T4 = u4.type;
    if (void 0 !== u4.constructor) return null;
    128 & t3.__u && (c3 = !!(32 & t3.__u), o3 = [f4 = u4.__e = t3.__e]), (a3 = l.__b) && a3(u4);
    n: if ("function" == typeof T4) try {
      if (S2 = u4.props, C4 = T4.prototype && T4.prototype.render, M3 = (a3 = T4.contextType) && i3[a3.__c], $3 = a3 ? M3 ? M3.props.value : a3.__ : i3, t3.__c ? b3 = (h4 = u4.__c = t3.__c).__ = h4.__E : (C4 ? u4.__c = h4 = new T4(S2, $3) : (u4.__c = h4 = new x(S2, $3), h4.constructor = T4, h4.render = G), M3 && M3.sub(h4), h4.state || (h4.state = {}), h4.__n = i3, p3 = h4.__d = true, h4.__h = [], h4._sb = []), C4 && null == h4.__s && (h4.__s = h4.state), C4 && null != T4.getDerivedStateFromProps && (h4.__s == h4.state && (h4.__s = w({}, h4.__s)), w(h4.__s, T4.getDerivedStateFromProps(S2, h4.__s))), y3 = h4.props, _3 = h4.state, h4.__v = u4, p3) C4 && null == T4.getDerivedStateFromProps && null != h4.componentWillMount && h4.componentWillMount(), C4 && null != h4.componentDidMount && h4.__h.push(h4.componentDidMount);
      else {
        if (C4 && null == T4.getDerivedStateFromProps && S2 !== y3 && null != h4.componentWillReceiveProps && h4.componentWillReceiveProps(S2, $3), u4.__v == t3.__v || !h4.__e && null != h4.shouldComponentUpdate && false === h4.shouldComponentUpdate(S2, h4.__s, $3)) {
        ...
        null != h4.componentWillUpdate && h4.componentWillUpdate(S2, h4.__s, $3), C4 && null != h4.componentDidUpdate && h4.__h.push(function() {
          h4.componentDidUpdate(y3, _3, m3);
        });
      }
      if (h4.context = $3, h4.props = S2, h4.__P = n2, h4.__e = false, I3 = l.__r, A4 = 0, C4) h4.state = h4.__s, h4.__d = false, I3 && I3(u4), a3 = h4.render(h4.props, h4.state, h4.context), v.push.apply(h4.__h, h4._sb), h4._sb = [];
      else do {
        h4.__d = false, I3 && I3(u4), a3 = h4.render(h4.props, h4.state, h4.context), h4.state = h4.__s;
      } while (h4.__d && ++A4 < 25);
      h4.state = h4.__s, null != h4.getChildContext && (i3 = w(w({}, i3), h4.getChildContext())), C4 && !p3 && null != h4.getSnapshotBeforeUpdate && (m3 = h4.getSnapshotBeforeUpdate(y3, _3)), H3 = null != a3 && a3.type === k && null == a3.key ? q(a3.props.children) : a3, f4 = P(n2, d(H3) ? H3 : [H3], u4, t3, i3, r4, o3, e3, f4, c3, s3), h4.base = u4.__e, u4.__u &= -161, h4.__h.length && e3.push(h4), b3 && (h4.__E = h4.__ = null);
    } catch (n3) {
  ...
  function B(u4, t3, i3, r4, o3, e3, f4, c3, s3) {
    var a3, h4, v3, y3, w4, _3, m3, b3 = i3.props || p, k4 = t3.props, x4 = t3.type;
    ...
    if (null == x4) b3 === k4 || c3 && u4.data == k4 || (u4.data = k4);
      ...
      for (a3 in k4) w4 = k4[a3], "children" == a3 ? y3 = w4 : "dangerouslySetInnerHTML" == a3 ? h4 = w4 : "value" == a3 ? _3 = w4 : "checked" == a3 ? m3 = w4 : c3 && "function" != typeof w4 || b3[a3] === w4 || F(u4, a3, w4, b3[a3], o3);
  ...
  // src/webviews/components/ui/badge.tsx
  ...
  function Badge({ className, variant, ...props }) {
    return /* @__PURE__ */ u3("div", { className: cn2(badgeVariants({ variant }), className), ...props });
  }

  // src/webviews/sidebar/components/AgentCard.tsx
  var vscode = getVscodeApi();
  function AgentCard({ agent }) {
    const meta = agent.kind === "agent" ? `${agent.provider}${agent.model ? ` \u2022 ${agent.model}` : ""}` : `${agent.steps.length} step${agent.steps.length === 1 ? "" : "s"}`;
    return /* @__PURE__ */ u3("article", { class: "agent-card", children: [
      /* @__PURE__ */ u3("div", { class: "agent-topline", children: [
        /* @__PURE__ */ u3("h3", { class: "agent-name", children: agent.name }),
        /* @__PURE__ */ u3(Badge, { variant: "secondary", className: "agent-kind text-[10px]", children: agent.kind })
      ] }),
      /* @__PURE__ */ u3("p", { class: "agent-desc", children: agent.description ?? "No description provided." }),
      /* @__PURE__ */ u3("p", { class: "meta", children: meta }),
      /* @__PURE__ */ u3("div", { class: "agent-actions", children: [
        /* @__PURE__ */ u3(Button, { size: "sm", onClick: () => vscode.postMessage({ type: "runAgent", payload: { name: agent.name } }), children: "Run" }),
        /* @__PURE__ */ u3(Button, { size: "sm", variant: "outline", onClick: () => vscode.postMessage({ type: "editAgent", payload: { source: agent.source } }), children: "Edit" })
      ] })
    ] });
  }

  // src/webviews/sidebar/components/OutputPanel.tsx
  function OutputPanel({ lastRun }) {
    if (!lastRun) {
      return /* @__PURE__ */ u3("p", { className: "text-xs text-muted-foreground py-3 text-center", children: "Run an agent to see output here." });
    }
    const parts = [
      lastRun.kind,
      lastRun.provider ?? (lastRun.kind === "workflow" ? "workflow" : void 0),
      lastRun.durationMs ? `${lastRun.durationMs}ms` : void 0
    ].filter(Boolean);
    return /* @__PURE__ */ u3("div", { className: "flex flex-col gap-2", children: [
      /* @__PURE__ */ u3("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ u3("span", { className: "text-xs font-medium text-foreground truncate", children: lastRun.name }),
        /* @__PURE__ */ u3(Badge, { variant: "secondary", className: "text-[10px] shrink-0", children: "done" })
      ] }),
      /* @__PURE__ */ u3("p", { className: "text-[11px] text-muted-foreground", children: parts.join(" \u2022 ") }),
      /* @__PURE__ */ u3("pre", { className: "text-[11px] bg-muted rounded-md p-2 overflow-x-auto whitespace-pre-wrap break-all leading-relaxed max-h-48 overflow-y-auto", children: lastRun.output })
    ] });
  }

  // src/webviews/sidebar/App.tsx
  var vscode2 = getVscodeApi();
  function App() {
    const [agents, setAgents] = d2([]);
    const [lastRun, setLastRun] = d2(null);
    y2(() => {
      const handler = (event) => {
      ...
      vscode2.postMessage({ type: "ready" });
      return () => window.removeEventListener("message", handler);
    }, []);
    return /* @__PURE__ */ u3("div", { className: "flex flex-col gap-4 p-3", children: [
      /* @__PURE__ */ u3("header", { className: "flex flex-col gap-1", children: [
        /* @__PURE__ */ u3("h1", { className: "text-base font-semibold text-foreground", children: "DevAgents" }),
        /* @__PURE__ */ u3("p", { className: "text-xs text-muted-foreground", children: "AI-powered agents for your workspace." })
      ] }),
      /* @__PURE__ */ u3("div", { className: "flex gap-2", children: [
        /* @__PURE__ */ u3(Button, { size: "sm", className: "flex-1", onClick: () => vscode2.postMessage({ type: "createAgent" }), children: "+ New Agent" }),
        /* @__PURE__ */ u3(Button, { size: "sm", variant: "outline", onClick: () => vscode2.postMessage({ type: "refresh" }), children: "\u21BB" })
      ] }),
      /* @__PURE__ */ u3("section", { className: "flex flex-col gap-2", children: [
        /* @__PURE__ */ u3("h2", { className: "text-xs font-medium text-muted-foreground uppercase tracking-wider", children: "Agents & Workflows" }),
        /* @__PURE__ */ u3("div", { className: "flex flex-col gap-2", children: agents.length === 0 ? /* @__PURE__ */ u3("p", { className: "text-xs text-muted-foreground py-4 text-center", children: "No agents found in the current workspace." }) : agents.map((agent) => /* @__PURE__ */ u3(AgentCard, { agent }, agent.source)) })
      ] }),
      /* @__PURE__ */ u3("section", { className: "flex flex-col gap-2", children: [
        /* @__PURE__ */ u3("h2", { className: "text-xs font-medium text-muted-foreground uppercase tracking-wider", children: "Last Output" }),
        /* @__PURE__ */ u3(OutputPanel, { lastRun })
      ] })
    ] });
  }

  // src/webviews/sidebar/index.tsx
  var root = document.getElementById("root");
  if (root) J(/* @__PURE__ */ u3(App, {}), root);
})();
